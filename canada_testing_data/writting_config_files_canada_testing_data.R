...
column_mapping <- cfg_write(provided = c("id", "date", "age", "case_id", "country", "province", "region", "sex", "travel", "travelh"), 
                            ...
                            value_mapping_file = c(NA, NA, "age_levels.csv", NA, "country_levels.csv", "province_levels.csv", "region_levels.csv", "sex_levels.csv", "travel_levels.csv", "travelh_levels.csv"),
